...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  config.vm.hostname = "pollet.vagrant.net"
  ...
  config.vm.define :pwapi do |pwapi|
    ...
    pwapi.vm.network :private_network, ip: "172.16.22.10"
    # Mac
    pwapi.vm.synced_folder Dir::pwd, "/var/www/wasabi", :owner => 'vagrant', :group => 'vagrant', mount_options: ["dmode=775", "fmode=775"]
